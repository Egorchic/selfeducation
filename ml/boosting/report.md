...
При max_depth от 7 и выше замечено переобучение.
...
Графики показали что при learning_rate=0.01, n_esimators=2000, max_depth=5 достигается лучший результат в компромиссе между точностью и вычислительной сложностью

## Общий вывод

```text
MSE: 0.20679840168163913
R2: 0.8436082795969093
```

Значит модель объясняет примерно 84% дисперсии.